...
// end of FIXME(integers)
  ...
  @_inlineable // FIXME(sil-serialize-all)
  @_transparent
  public init(_bits: Builtin.Int8) {
    self._value = _bits
  }
...
// end of FIXME(integers)
  ...
  @_inlineable // FIXME(sil-serialize-all)
  @_transparent
  public init(_bits: Builtin.Int16) {
    self._value = _bits
  }
...
// end of FIXME(integers)
  ...
  public func dividedReportingOverflow(
    ...
    if _slowPath(
      other == (0 as Int16)
      || self == Int16.min && other == (-1 as Int16)
    ) {
      return (partialValue: self, overflow: true)
    }
...
// end of FIXME(integers)
  ...
  @_inlineable // FIXME(sil-serialize-all)
  @_transparent
  public init(_bits: Builtin.Int32) {
    self._value = _bits
  }
...
// end of FIXME(integers)
  ...
  public func dividedReportingOverflow(
    ...
    if _slowPath(
      other == (0 as Int32)
      || self == Int32.min && other == (-1 as Int32)
    ) {
      return (partialValue: self, overflow: true)
    }
...
// end of FIXME(integers)
  ...
  @_inlineable // FIXME(sil-serialize-all)
  @_transparent
  public init(_bits: Builtin.Int64) {
    self._value = _bits
  }
  ...
  public func dividingFullWidth(
    ...
    // FIXME(integers): tests
    let lhs = DoubleWidth<UInt64>(dividend)
    let rhs = DoubleWidth<UInt64>(self)
    ...
    return (UInt64(quotient.low), UInt64(remainder.low))
  }
...
// end of FIXME(integers)
  ...
  public func dividedReportingOverflow(
    ...
    if _slowPath(
      other == (0 as Int64)
      || self == Int64.min && other == (-1 as Int64)
    ) {
      return (partialValue: self, overflow: true)
    }
  ...
  public func dividingFullWidth(
    ...
    // FIXME(integers): tests
    let lhs = DoubleWidth<Int64>(dividend)
    let rhs = DoubleWidth<Int64>(self)

    let (quotient, remainder) = lhs.quotientAndRemainder(dividingBy: rhs)
    // FIXME(integers): check for high words in quotient and remainder
    return (Int64(quotient.low), Int64(remainder.low))
  }
...
// end of FIXME(integers)
  ...
  public func dividingFullWidth(
    ...
    // FIXME(integers): tests
    let lhs = DoubleWidth<UInt>(dividend)
    let rhs = DoubleWidth<UInt>(self)

    let (quotient, remainder) = lhs.quotientAndRemainder(dividingBy: rhs)
    // FIXME(integers): check for high words in quotient and remainder
    return (UInt(quotient.low), UInt(remainder.low))
  }
...
// end of FIXME(integers)
  ...
  public func dividingFullWidth(
    ...
    // FIXME(integers): tests
    let lhs = DoubleWidth<Int>(dividend)
    let rhs = DoubleWidth<Int>(self)

    let (quotient, remainder) = lhs.quotientAndRemainder(dividingBy: rhs)
    // FIXME(integers): check for high words in quotient and remainder
    return (Int(quotient.low), Int(remainder.low))
  }
