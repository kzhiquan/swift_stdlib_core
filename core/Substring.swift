...
extension Substring {
  ...
  public struct CharacterView {
    @_versioned // FIXME(sil-serialize-all)
    internal var _slice: Slice<String.CharacterView>
  }
}
...
extension Substring.CharacterView : BidirectionalCollection {
  ...
  internal init(_ base: String.CharacterView, _bounds: Range<Index>) {
    _slice = Slice(
      base: String(base._guts).characters,
      bounds: _bounds)
  }
...
extension Substring {
  ...
  public var characters: CharacterView {
    get {
      return CharacterView(_wholeString.characters, _bounds: startIndex..<endIndex)
    }
    set {
      self = Substring(newValue)
    }
